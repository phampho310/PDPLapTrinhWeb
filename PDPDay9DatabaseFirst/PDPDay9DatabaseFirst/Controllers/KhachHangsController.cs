...
namespace PDPDay9DatabaseFirst.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MaKhachHang,HoTenKhachHang,Email,MatKhau,DienThoai,DiaChi,NgayDangKy,TrangThai")] KhachHang khachHang)
        {
